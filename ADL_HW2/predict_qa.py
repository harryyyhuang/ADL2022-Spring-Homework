...
def parse_args():
    ...
    parser.add_argument(
        "--test_file", type=str, default="./cache/multi_choice.json", help="A csv or a json file containing the testing data."
    )
    parser.add_argument(
...
def main():
    ...
    test_dataloader = DataLoader(
        test_dataset_for_model, collate_fn=data_collator, batch_size=args.per_device_eval_batch_size
    )
    ...
    post_processing_function(test_examples, test_dataset, outputs_numpy)
